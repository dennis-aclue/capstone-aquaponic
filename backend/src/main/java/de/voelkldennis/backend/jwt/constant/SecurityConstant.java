...
public class SecurityConstant {
    ...
    public static final String JWT_TOKEN_HEADER = "Jwt-Token"; // Default custom HTTP header
    ...
    //public static final String[] PUBLIC_URLS = {"/user/login", "/user/register", "/user/resetpassword/**", "/user/image/**", "/api/projects/freeGallery", "/api/projects/freeProjectCard", };
